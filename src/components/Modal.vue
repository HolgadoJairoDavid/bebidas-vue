            ...
            >
              <div>
                <div class="mt-3">
                    ...
                    <img :src="bebidasStore.receta.strDrinkThumb" :alt="`Imagen de ${bebidasStore.receta.strDrink}`" class="mx-auto w-96">
                    <DialogTitle as="h3" class="text-gray-900 text-4xl font-extrabold my-5">
              ...
              <div class="mt-5 sm:mt-6 flex justify-between gap-4">
                ...
                <button class="w-full rounded bg-orange-600 p-3 font-bold uppercase text-white shadow hover:bg-gray-500" 
